...
class submitCheckListScreen extends StatefulWidget {
  final HeaderQuestion checkList;
  ...
  submitCheckListScreen(this.checkList, this.activeCheckList, this.i,
      this.mGetActvityTypes, this.locationsList);

  // submitCheckListScreen({Key? key}) : super(key: key);

  @override
  State<submitCheckListScreen> createState() => _submitCheckListScreenState(
      this.checkList,
...
class _submitCheckListScreenState extends State<submitCheckListScreen> {
  HeaderQuestion checkList;
  ActiveCheckList activeCheckList;
  final GetActvityTypes mGetActvityTypes;
  final String locationsList;

  _submitCheckListScreenState(this.checkList, this.activeCheckList,
      this.mGetActvityTypes, this.locationsList);
