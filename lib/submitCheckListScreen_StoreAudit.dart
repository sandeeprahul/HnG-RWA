...
class submitCheckListScreen_StoreAudit extends StatefulWidget {
 final HeaderQuesStoreAudit checkList;
 ...
 final LPDSection mLpdChecklist;
  ...
  @override
  State<submitCheckListScreen_StoreAudit> createState() =>
      _submitCheckListScreen_StoreAuditState(
...
var subQues = [];
var questionTitles = [];
double rating_=0.0,rating2_=0.0;
...
class _submitCheckListScreen_StoreAuditState
    extends State<submitCheckListScreen_StoreAudit> {
  HeaderQuesStoreAudit checkList;
                                ...
                                return InkWell(
                                  onTap: () {
                                    ...
                                    setState(() {
                                      ...
                                      option_mandatory_Flag = answerOptions[pos].optionMandatoryFlag;
                                    });
...
/*
  ...
  Future<void> getData() async {
    try {
      ...
      String url =
          "${Constants.apiHttpsUrl}/StoreAudit/QuestionAnswers/${widget.checkList.store_checklist_assign_id}/${widget.checkList.checklisTItemMstId}/InProcess/$userId"; //
      ...
      setState(() {
        ...
        departName = questionAnswers.department_Name.toString();
      });
        ...
        for (int i = 0; i < quesAnsList[0].questions.length; i++) {
          ...
          if (quesAnsList[0].questions[i].answerTypeId == 4) {
            ...
            sendJson.add({
              ...
              "mandatory_Flag": widget.checkList.mandatoryFlag,
              "active_Flag": widget.checkList.activeFlag,
              "checkList_Answer_Option_Id": answerOptionsComment_1[0].checkListAnswerOptionId,
              "answer_Option": sealnoCntrl.text.toString(),
              "we_Care_Flag": answerOptionsComment_1[0].nonComplianceFlag,
            ...
            sendJson.add({
              ...
              "non_Compliance_Flag": answerOptionsAttachProof_3[0].nonComplianceFlag,
              "pos_bos_flag": widget.activeCheckList.posBosFlag,
              "order_flag": int.parse(quesAnsList[0].questions[i].orderFlag),
              "store_checklist_assign_id":
              widget.activeCheckList.store_checklist_assign_id,
          ...
          } else if (quesAnsList[0].questions[i].answerTypeId == 5&&quesAnsList[0].questions[i].question=="Store Rating") {
            sendJson.add({
              "checkList_Item_Mst_Id": widget.checkList.checklisTItemMstId,
              "checklist_Id": widget.checkList.checklistId,
              "item_name": questionTitles[i],
          ...
          else if (quesAnsList[0].questions[i].answerTypeId == 5&&quesAnsList[0].questions[i].question=="Department Rating") {
            sendJson.add({
              "checkList_Item_Mst_Id": widget.checkList.checklisTItemMstId,
              "checklist_Id": widget.checkList.checklistId,
              "item_name": questionTitles[i],
              ...
              "checkList_Answer_Option_Id":
              quesAnsList[0].questions[i].options[0].checkListAnswerOptionId,
              "answer_Option": rating2_.toString(),
              "we_Care_Flag": widget.activeCheckList.weCareFlag,
              "non_Compliance_Flag": 0,
              "pos_bos_flag": widget.activeCheckList.posBosFlag,
              "order_flag": int.parse(quesAnsList[0].questions[i].orderFlag),
