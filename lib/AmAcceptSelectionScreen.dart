...
class AmAcceptSelectionScreen extends StatefulWidget {
  ...
  AmAcceptSelectionScreen(
      this.id, this.activeCheckList, this.mGetActvityTypes, this.locationsList);

  @override
  State<AmAcceptSelectionScreen> createState() => _AmAcceptSelectionScreenState(
      this.id, this.activeCheckList, this.mGetActvityTypes, this.locationsList);
}

class _AmAcceptSelectionScreenState extends State<AmAcceptSelectionScreen> {
  int id;
  ActiveCheckList activeCheckList;
  final GetActvityTypes mGetActvityTypes;
  final String locationsList;

  _AmAcceptSelectionScreenState(
      this.id, this.activeCheckList, this.mGetActvityTypes, this.locationsList);
                                  ...
                                  setState(() {
                                    ...
                                    for (int i = 0;
                                      ...
                                      setState(() {
                                        ...
                                        mAmHeaderQuestion_notSelected.remove(i);
                                      });
                                    }
                          ...
                          : mAmHeaderQuestion.isEmpty
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (context, pos) {
                                    var time = mAmHeaderQuestion[pos]
                                        .updatedByDatetime;
  ...
  List<AmHeaderQuestion> mAmHeaderQuestionTemp = [];
  late AmHeaderQuestion amHeaderQuestionTemp;
  ...
  Future<void> getData() async {
    try {
      ...
      String url =
          "${Constants.apiHttpsUrl}/CheckList/$type/${widget.activeCheckList.checklistAssignId}";
  ...
  setData(int pos) async {
    ...
    int i = pos;
    amHeaderQuestionTemp = mAmHeaderQuestion[i];
  ...
  Future<void> _showOnlyRetryAlert() async {
    return showDialog<void>(
      context: context,
      barrierDismissible: false, // user must tap button!
      builder: (BuildContext context) {
  ...
  Widget listOfData() {
    return Expanded(
        child: StreamBuilder<List<AmHeaderQuestion>?>(
            stream: null,
            builder: (context, snapshot) {
              ...
              if (snapshot.hasError) {
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, pos) {
                        ...
                        DateTime parseDate = DateFormat("dd-MM-yyyy hh:mm:ss")
                            .parse(mAmHeaderQuestion[pos].updatedByDatetime);
                        var inputDate = DateTime.parse(parseDate.toString());
                        var outputFormat = DateFormat('hh:mm a');
                        /*   var time_ =
                        outputFormat.format(inputDate);*/
                ...
                return const Text('Please after sometime');
              }
            }));
  }
