class ActiveCheckListAm {
    ActiveCheckListAm({
        required this.amChecklistAssignId,
    ...
    factory ActiveCheckListAm.fromJson(Map<String, dynamic> json) => ActiveCheckListAm(
        amChecklistAssignId: json["am_checklist_assign_id"],
    ...
    Map<String, dynamic> toJson() => {
        "am_checklist_assign_id": amChecklistAssignId,
