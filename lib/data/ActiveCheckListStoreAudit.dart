class ActiveCheckListStoreAudit {
  ActiveCheckListStoreAudit({
  ...
  factory ActiveCheckListStoreAudit.fromJson(Map<String, dynamic> json) => ActiveCheckListStoreAudit(
    store_checklist_assign_id: json["store_checklist_assign_id"]??-1,
