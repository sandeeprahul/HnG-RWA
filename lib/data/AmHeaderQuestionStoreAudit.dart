...
// import 'dart:convert';
//
// //List<AmHeaderQuestionStoreAudit> amHeaderQuestionStoreAuditFromJson(String str) => List<AmHeaderQuestionStoreAudit>.from(json.decode(str).map((x) => AmHeaderQuestionStoreAudit.fromJson(x)));
// //
// //String amHeaderQuestionStoreAuditToJson(List<AmHeaderQuestionStoreAudit> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
//
// class AmHeaderQuestionStoreAudit {
//     int storeChecklistAssignId;
...
//
//     AmHeaderQuestionStoreAudit({
//         required this.storeChecklistAssignId,
...
//     });
//
//     factory AmHeaderQuestionStoreAudit.fromJson(Map<String, dynamic> json) => AmHeaderQuestionStoreAudit(
//         storeChecklistAssignId: json["store_checklist_assign_id"],
...
//         "store_checklist_assign_id": storeChecklistAssignId,
...
List<AmHeaderQuestionStoreAudit> amHeaderQuestionStoreAuditFromJson(
        String str) =>
    List<AmHeaderQuestionStoreAudit>.from(
        json.decode(str).map((x) => AmHeaderQuestionStoreAudit.fromJson(x)));

String amHeaderQuestionStoreAuditToJson(
        List<AmHeaderQuestionStoreAudit> data) =>
...
class AmHeaderQuestionStoreAudit {
  ...
  factory AmHeaderQuestionStoreAudit.fromJson(Map<String, dynamic> json) =>
      AmHeaderQuestionStoreAudit(
        storeChecklistAssignId: json["store_checklist_assign_id"],
        checklisTItemMstId: json["checklisT_ITEM_MST_ID"],
        itemName: json["item_name"],
        ...
        checklistEditStatus: json["checklist_edit_status"],
        nonComplianceFlag: json["non_compliance_flag"],
        checkListDetails: json["check_list_details"] == null
            ? []
            : List<CheckListDetail>.from(json["check_list_details"]!
                .map((x) => CheckListDetail.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "checklist_edit_status": checklistEditStatus,
        "non_compliance_flag": nonComplianceFlag,
        "check_list_details": checkListDetails == null
            ? []
            : List<dynamic>.from(checkListDetails!.map((x) => x.toJson())),
      };
}
...
class CheckListDetail {
  ...
  factory CheckListDetail.fromJson(Map<String, dynamic> json) =>
      CheckListDetail(
        ...
        checklistDetailImages:
            List<dynamic>.from(json["checklist_Detail_Images"].map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "image_Seq_Id": imageSeqId,
        "image_Name": imageName,
        "checklist_Detail_Images":
            List<dynamic>.from(checklistDetailImages.map((x) => x)),
      };
}
