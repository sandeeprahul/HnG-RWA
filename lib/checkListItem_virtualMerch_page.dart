...
import 'package:hng_flutter/submitCheckList_virtualMerch_page.dart';
...
class checkListItemVirtualMerchPage extends StatefulWidget with WidgetsBindingObserver {
  ...
  @override
  State<checkListItemVirtualMerchPage> createState() => _checkListItemVirtualMerchPageState(
      this.activeCheckList, this.mGetActvityTypes, this.locationsList);
}

class _checkListItemVirtualMerchPageState extends State<checkListItemVirtualMerchPage>
    with WidgetsBindingObserver {
  ActiveCheckListVirtualMerchEntity activeCheckList;
  final GetActvityTypes mGetActvityTypes;
  final String locationsList;

  _checkListItemVirtualMerchPageState(
      this.activeCheckList, this.mGetActvityTypes, this.locationsList);
                                ...
                                Row(
                                  children: [
                                    Align(
                                      alignment: Alignment.topLeft,
                                      child: Text(
                                        'Checklist No : ${widget.activeCheckList.vm_assign_id} ',
                                        style: const TextStyle(
                                          fontSize: 12,
                                        ),
                                      ),
                            ...
                            onTap: () {
                              ...
                              if (headerQuestion[pos]
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          submitCheckListVirtualMerchPage(
                                              headerQuestion[pos],
  ...
  List<HeaderQuestionVirtualMerchEntity> headerQuestion = [];
  ...
  Future<void> getData() async {
    try {
      ...
      String url =
          "${Constants.apiHttpsUrl}/VirtualMerchandiser/HeaderQuestion/${widget.activeCheckList.vm_assign_id}/$userID";
...
/*    HeaderQuestion headerQuestionFromJson(String str) => HeaderQuestion.fromJson(json.decode(str));
    ...
    headerQuestion = users;*/
      data.forEach((element) {
        headerQuestion.add(HeaderQuestionVirtualMerchEntity.fromJson(element));
      });
    ...
    try {
      ...
      var response = await http
          .post(
            ...
            body: jsonEncode({
              "vm_assign_id": widget.activeCheckList.vm_assign_id
            }),
          )
